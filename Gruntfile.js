...
module.exports = function (grunt) {
	grunt.initConfig({
		...
		concurrent: {
			...
			build: {
				tasks: ['stylus:main', 'jade:main', 'jade:templates', 'copy:main', 'copy:lib', 'copy:libStatic', 'copy:img']
			},
			watch: {
	...
	grunt.registerTask('default', ['clean', 'concurrent:build', 'concurrent:dev']);
};